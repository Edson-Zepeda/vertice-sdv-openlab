...
| Alta | Al ampliar grafos densos, los nodos salían del SVG y cubrían los botones de zoom. | El usuario perdía acceso a ampliar, reducir o centrar el lienzo. El ensayo prolongado detectó el bloqueo. | Recortar el dibujo al viewport del SVG, conservando la barra de herramientas fuera del área del grafo. | [Seis escenarios fallidos](../evidence/ui/zoom-viewport/before.json), [192 comprobaciones después](../evidence/ui/zoom-viewport/after.json) |
